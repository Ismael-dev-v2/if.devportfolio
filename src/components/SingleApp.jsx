...
const SingleApp = () => {
  ...
  return (
    <section className="h-full mb-14 max-w-xl w-full ">
      ...
      <div className='flex flex-col md:flex-row justify-between items-start w-full gap-8 px-4'>
        <div className='div1 w-[50vw]'>
        ...
        <div className='div2 flex flex-col w-full'>   
          <img
